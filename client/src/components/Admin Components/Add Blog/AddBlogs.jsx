    ...
    <div className='p-4 h-screen'>
        ...
        <form action="" className='my-4 flex flex-col gap-4'>
            <input 
                type="text" 
                placeholder='Title'  
                className='borde-none outline-none p-4 bg-transparent text-3xl border-b border-zinc-400 font-semibold w-full'
            />
            <textarea 
                type="text" 
            ...
            <div>
                <button className='bg-blue-600 text-white rounded px-4 py-2 shadow-xl hover:bg-blue-700 transition-all duration-300 '>
                    Add Blog
                </button>
            </div>
        </form>
